    ...
    <div style={{ 
      ...
      <Card style={{ width: 400, boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <Title level={2}>Sistema de Auditoría de Sistemas</Title>
          <p>Evaluación de Activos de Información Bancarios</p>
          <p style={{ fontSize: '14px', color: '#666' }}>Ingresa tus credenciales para acceder</p>
        </div>
